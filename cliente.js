...
/**
 * Funzione principale per gestire l'aggiunta al carrello (Bandiere). (MODIFICATA PER IL CALCOLO PREZZI)
 */
...
async function gestisciCheckout() {
    ...
    try {
        const { error } = await supabase
            .from('ordini')
            .insert([{ num_ordine_prog: numeroOrdineGenerato, stato: 'In attesa di lavorazione', totale: totaleCalcolato, dettagli_prodotti: carrelloDaSalvare }]);
