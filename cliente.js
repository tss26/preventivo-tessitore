...
            const content = document.getElementById('dtfInfoContent');
            ...
            const prezzo = LISTINO_COMPLETO.DTF.PREZZO_AL_METRO_LINEARE.toFixed(2);
            
            if (content.style.display === 'block') {
                content.style.display = 'none';
            } else {
                content.innerHTML = `<p><strong>Prezzo:</strong> €${prezzo} al metro lineare.</p><p><strong>Larghezza Fissa:</strong> ${larghezza} cm.</p><p><strong>Requisiti File:</strong> Vettoriale (.PDF) o Raster (.PNG ad alta risoluzione, 300dpi).</p>`;
